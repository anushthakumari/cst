			...
			<Container>
				<div className="md:w-2/3 lg:w-1/2">
					...
					<p className="text-gray-300">
						Here at academic turf, we sit amet consectetur adipisicing elit.
						Natus ad ipsum pariatur autem, fugit laborum in atque amet
						obcaecati? Nisi minima aspernatur, quidem nulla cupiditate nam
